// app/(produtoraloha)/dashboard/meventos/_components/EventCard.tsx
      ...
      <div className="flex flex-col md:flex-row p-5 gap-6">
        ...
        <div className="relative w-full md:w-48 h-32 bg-zinc-100 rounded-2xl overflow-hidden border border-zinc-100 shrink-0">
          ...
          {event.image ? (
            ...
            <div className="w-full h-full flex items-center justify-center text-[10px] font-black uppercase text-zinc-400">
        ...
        <div className="flex-1 flex flex-col justify-between py-1">
          ...
          <div>
            ...
            <div className="flex justify-between items-start">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuTrigger className="p-1 hover:bg-zinc-100 rounded-lg">
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem asChild>
                    ...
                    <Link
                      ...
                      className="gap-2 text-xs font-bold uppercase italic"
                    >
                  ...
                  <DropdownMenuItem className="gap-2 text-xs font-bold uppercase italic">
                  ...
                  <DropdownMenuItem asChild>
                    ...
                    <Link
                      ...
                      className="gap-2 text-xs font-bold uppercase italic text-blue-600"
                    >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 border-t border-zinc-50 pt-4">
            ...
            <div>
              ...
              <p className="text-xs font-black text-zinc-900 italic">
